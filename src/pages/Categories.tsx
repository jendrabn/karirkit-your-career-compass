                ...
                <TableRow className="hover:bg-transparent">
                  <TableCell colSpan={5} className="text-center py-16 text-muted-foreground">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-base font-medium">Tidak ada kategori</p>
                      <p className="text-sm">Mulai buat kategori pertama Anda</p>
                    </div>
                  </TableCell>
                </TableRow>
              ) : (
      ...
      <AlertDialog open={bulkDeleteDialogOpen} onOpenChange={setBulkDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tindakan ini tidak dapat dibatalkan. Semua kategori yang dipilih akan dihapus secara permanen.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Batal</AlertDialogCancel>
